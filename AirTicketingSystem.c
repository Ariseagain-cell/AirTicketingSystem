...
int main(void)
{
    ...
    FlightList f1 = Creat_Flight("北京","南方航空CZ3586","A320","2022-01-05-12:00",100,20);
    FlightList f2 = Creat_Flight("北京","中国国航CA1352","A321","2022-01-06-13:00",120,12);
    FlightList f3 = Creat_Flight("上海","东方航空MU9528","波音737","2022-01-05-12:00",120,120);
    FlightList f4 = Creat_Flight("三亚","南方航空CZ6748","波音747","2022-01-05-15:00",100,100);
    Insert_Flight(&flight, &f1);
    Insert_Flight(&flight, &f2);
    Insert_Flight(&flight, &f3);
    Insert_Flight(&flight, &f4);
